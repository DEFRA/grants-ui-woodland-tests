...
export const config = {
  ...
  baseUrl: `https://grants-ui-woodland-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `grants-ui-woodland-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `grants-ui-woodland-tests-${process.env.ENVIRONMENT}`
        },
